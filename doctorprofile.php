...
<body>
    <div class="main-content">
        ...
        <!-- Header -->
        <div class="header pb-8 pt-5 " style="min-height: 10px;">
            <!-- Mask -->
        ...
        <div class="container-fluid mt--7">
            <div class="row">
                <div class="col-xl-20 order-xl-20">
                    <div class="card bg-secondary shadow">
                        ...
                        <div class="card-body">
                            <form>
                                <h6 class="heading-small text-muted mb-6">Profile</h6>
                                <div class="pl-lg-4">
                                    <div class="row">
                                        <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group focused">
                                                ...
                                                <input type="text" id="input-username" class="form-control form-control-alternative" placeholder="Age">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group focused">
                                                ...
                                                <input id="input-address" class="form-control form-control-alternative" placeholder="Name of the clinic", nr. 8 Bl 1, Sc 1, Ap 09" type="text">
                                            </div>
                                            <div class="form-group focused">
                                                <label class="form-control-label" for="input-address">Address</label>
                                                <input id="input-address" class="form-control form-control-alternative" placeholder="Clinic Address" , nr. 8 Bl 1, Sc 1, Ap 09" type="text">
                                            </div>
                                        </div>
                                    </div>
                                </div>
