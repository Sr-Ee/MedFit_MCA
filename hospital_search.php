...
if(isset($_POST['submit']))
{
    ...
    $user_query = mysqli_query($con,"SELECT * FROM `hospital`");
    ...
    while($row = mysqli_fetch_array($user_query)){
        ...
        $search_user_id = $row['hospital_id'];
    }
...
?>
    ...
    <div class="container">
        <form action="doctor_details.php?doctor_id=<?php echo $search_user_id ?>">
            <header class="header">
                <h4 class="title">Live Hospital Filter</h4>
                <small class="subtitle">Search Hospital's by Name, location</small>
