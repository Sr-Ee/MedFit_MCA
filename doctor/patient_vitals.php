...
if(isset($_POST['submit']))
{
    ...
    $query = "INSERT INTO `patient_vitals` (`doc_id`, `pat_id`, `sys_bp`, `dys_bp`, `heart_rate`, `temp`, `resp_rate`, `weight`, `height`, `bmi`, `sugar`, `ox_sat`, `allergies`, `curr_med`, `med_hist`, `symptoms`, `vit_date`, `vit_time`) VALUES ('$doctorid', '1', '2', '2', '2', '2', '2', '2', '2', '2', '2', '2', 'test', 'test', 'test', 'test', 'test', 'test');";
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
            ...
            <div class="container form-box">
                <form class="app" method="post" action="pdf.php">
                    <!-- Form start -->
                    <div class="row">
                        <!-- Text input-->
                        <div class="col-md-6">
