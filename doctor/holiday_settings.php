...
if(isset($_POST['submit']))
{
    ...
    $query = "INSERT INTO `holiday_settings` (`doc_id`, `holi_date`) VALUES ('$doctorid', '$slot_time');";
...
if(isset($_GET['delete'])){
    ...
    $query = "DELETE FROM `holiday_settings`  WHERE `date_id` = {$the_slot_id} ";
    $delete_query = mysqli_query($con,$query);
    header("location: holiday_settings.php");
    }
?>
    ...
    <div id="page-wrapper">
        <h2>Add Holiday Settings</h2>
            ...
            <div class="container form-box">
                <form class="app" action="holiday_settings.php" method="post">
                    <!-- Form start -->
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="slot">Holiday Date</label>
                                    <input id="slot" name="slot" type="text" placeholder="Enter Holiday Date in YYYY-MM-DD format"
                            ...
                            <div class="col-md-6">
                                ...
                                <?php
                                    $query = "SELECT * FROM `holiday_settings` WHERE `doc_id` = '$doctorid'";
                                    ...
                                    echo "<td>{$date_id}</td>";
                                    echo "<td>{$holi_date}</td>";
                                    echo "<td><a href='holiday_settings.php?delete={$date_id}'>Delete</a></td>";
                                    echo "</tr>";
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <button id="submit" name="submit" class="btn btn-primary">Add Date</button>
                            </div>
                        </div>
                    </div>
                    <?php echo $msg;  ?>
